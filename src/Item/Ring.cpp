...
Ring::Ring(string pname, int pvalue, int pweight, int pcharismanBonus, int pwisdomBonus, int pintBonus, string ptextureName):Equipment(pname, pvalue, pweight, ptextureName){
...
Ring::Ring(int charLevel, bool isRandom, string ptextureName):Equipment(charLevel, isRandom, ptextureName){
